    ...
    <footer style={{ background: "var(--forest)", color: "rgba(255,255,255,0.6)" }}>
      ...
      >
        ...
        <div className="md:col-span-1">
          ...
          <p style={{ fontSize: 13, lineHeight: 1.8, marginBottom: 20 }}>
            South India&apos;s first premium rice brand with a health story. Farm to your kitchen — aged, tested, transparent.
          </p>
          <p style={{ fontSize: 11, color: "rgba(200,150,10,0.7)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
            Bangalore Delivery · Day 1
          </p>
        </div>
        ...
        <div>
          ...
          <p style={{ fontSize: 13, marginBottom: 8 }}>📍 Bangalore, Karnataka</p>
          ...
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", marginTop: 16, lineHeight: 1.6 }}>
            FSSAI Licensed · 100% Natural · No Preservatives
          </p>
        </div>
      </div>
      ...
      >
        <p style={{ fontSize: 12, color: "rgba(255,255,255,0.3)" }}>
          © 2026 Grainary · All rights reserved
        </p>
        <p style={{ fontSize: 12, color: "rgba(255,255,255,0.3)" }}>
