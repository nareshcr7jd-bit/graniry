...
const PRODUCT_DATA = [
  {
    ...
    description:
      "Our flagship. Aged 12–24 months to reduce starch and lower the glycemic index. The rice South Indian households trust — now with a story.",
    longDescription:
      "Aged Sona Masoori raw rice loses moisture over 12–24 months, dropping starch content by up to 30%. The glycemic index falls from 72 to around 56 — clinically lower than fresh rice. Every grain is sorted by our Sortex colour-sorter, moisture-tested to below 11%, and batch-coded on the bag.",
    pricePerKg: 75,
  ...
  },
  {
    ...
    description:
      "Parboiled Sona Masoori for faster cooking. The steam process locks nutrients inside the grain before milling.",
    longDescription:
      "Steam (parboiled) rice undergoes partial boiling before milling. This drives nutrients from the bran into the grain — making it more nutritious than polished raw rice. It cooks faster, has a firmer texture, and is easier on digestion.",
    pricePerKg: 68,
    category: "everyday" as const,
  ...
  },
  {
    ...
    description:
      "Short-grain raw rice with the high starch content needed for an airy, fermented batter. Ground smooth for a silky texture.",
    longDescription:
      "Not all rice makes great idli. This short-grain variety has elevated amylopectin starch — the type that ferments well and gives idli its signature softness. Our lot is cleaned, sorted, and packed within days of milling for maximum freshness.",
    pricePerKg: 58,
    category: "everyday" as const,
  ...
  },
  {
    ...
    description:
      "Aged 18+ months. Slender grain with a natural mild aroma. The choice of Bangalore's best cloud kitchens and hotels.",
    longDescription:
      "RNR rice — also called Jeera Sona for its cumin-seed like shape — is the longest-aged variety we carry. At 18+ months, moisture drops below 10%, the starch crystallises, and the grain cooks non-sticky with a beautiful separated texture. This is what your favourite biryani restaurant uses.",
    pricePerKg: 90,
  ...
  },
  {
    ...
    description:
      "Our most scientifically positioned product. Aged 18–24 months, batch-tested GI of 54. Eat rice on your diet — guilt-free.",
    longDescription:
      "Most people avoid rice while dieting because of generic advice about carbs. That advice was written about fresh, high-starch rice. Diet Rice is aged 18–24 months — starch crystallises, moisture drops to 9.2%, and the glycemic index falls to 54 (low GI). We test every batch. The result is on the bag.",
    pricePerKg: 89,
  ...
  },
  {
    ...
    description:
      "A precision blend of Sona Masoori + Red Rice + Brown Rice + Foxtail Millet + Barnyard Millet. More protein, more fibre, more flavour.",
    longDescription:
      "Built for gym-goers, athletes, and anyone who wants more from their rice. Our 5-grain formula — 50% Sona Masoori, 20% Red Rice, 15% Brown Rice, 10% Foxtail Millet, 5% Barnyard Millet — hits 8.9g protein per 100g cooked (vs 6.8g for white rice). Earthy, nutty, and satisfying.",
    pricePerKg: 110,
    category: "multigrain" as const,
  ...
  },
  {
    ...
    description:
      "Tamil Nadu's heirloom Kavuni rice. Deep red-black colour from anthocyanin pigments — the same antioxidants in blueberries.",
    longDescription:
      "Mappillai Samba and Kavuni are ancient Tamil rice varieties grown for over 2,000 years. The deep red-black colour is natural anthocyanin — powerful antioxidants linked to heart health and anti-inflammation. Higher protein than white rice, nutty flavour, and a slightly chewy texture.",
    pricePerKg: 130,
  ...
  },
  {
    ...
    description:
      "Unpolished Sona Masoori with the bran intact. Maximum fibre, B-vitamins, and magnesium. The nutritional benchmark.",
    longDescription:
      "Brown rice is white rice before the bran is stripped away. By keeping the bran intact, we preserve 3.5g fibre per 100g (vs 0.4g for polished white), plus significant B-vitamins, magnesium, and phosphorus. The nutty, chewy texture is distinct.",
    pricePerKg: 80,
    category: "diet" as const,
